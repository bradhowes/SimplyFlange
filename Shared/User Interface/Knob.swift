...
/**
 Custom view that depicts a value as a point on a circle. Changing the value is done by touching on the control
...
open class Knob: Control {
    ...
    open var progressColor: Color = .systemTeal { didSet { progressLayer.strokeColor = progressColor.cgColor } }
    ...
    open var indicatorColor: Color = .systemTeal { didSet { indicatorLayer.strokeColor = indicatorColor.cgColor } }
    ...
    /// The color of the radial line drawn from the current value on the arc towards the arc center.
    open var radialLineColor: Color = .systemTeal { didSet { radialLayer.strokeColor = radialLineColor.cgColor } }
    ...
    open var tickLineColor: Color = .systemTeal { didSet { ticksLayer.strokeColor = tickLineColor.cgColor } }
...
extension Knob {
    ...
    private func createTrack() {
        let ring = BezierPath(arcCenter: CGPoint.zero, radius: radius, startAngle: CGFloat(startAngle),
    ...
    private func createProgressTrack() {
        let path = BezierPath(arcCenter: CGPoint.zero, radius: radius, startAngle: CGFloat(startAngle),
                              endAngle: CGFloat(endAngle), clockwise: true)
