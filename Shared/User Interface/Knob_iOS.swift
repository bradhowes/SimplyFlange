...
@IBDesignable open class Knob: UIControl {
    ...
    @IBInspectable open var touchSensitivity: Float = 1.0

    /// The width of the arc that is shown after the current value.
    @IBInspectable open var trackLineWidth: CGFloat = 6 { didSet { trackLayer.lineWidth = trackLineWidth } }
    ...
    @IBInspectable open var progressLineWidth: CGFloat = 4 { didSet { progressLayer.lineWidth = progressLineWidth } }

    /// The color of the arc from the start up to the current value.
    @IBInspectable open var progressColor: UIColor = .systemOrange { didSet { progressLayer.strokeColor = progressColor.cgColor } }
    ...
    @IBInspectable open var indicatorColor: UIColor = .systemOrange { didSet { indicatorLayer.strokeColor = indicatorColor.cgColor } }
    ...
    @IBInspectable open var tickCount: Int = 3 { didSet { createShapes() } }
